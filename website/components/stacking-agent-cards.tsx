...
const AGENTS = [
  {
    label: "INBOX AGENT",
    title: "Conversations, understood",
    desc: "Reads every connected channel, prioritises what matters, prepares clear briefs, drafts replies, and keeps every customer thread in context.",
    stats: [{ v: "24/7", l: "coverage" }, { v: "1", l: "shared inbox" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/researcher-CvhqOuV6irGwBOnJoTGFlXdbyYBRjb.png",
  },
  {
    label: "CRM AGENT",
    title: "Customer records, always current",
    desc: "Enriches leads, retrieves account context, creates quotations, and moves approved work forward across your connected CRM.",
    stats: [{ v: "Live", l: "CRM context" }, { v: "0", l: "manual handoffs" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/coder-9bItvCegU6TXUqbX3tUXGBAtvkBkXp.png",
  },
  {
    label: "IVY",
    title: "One intelligence across every agent",
    desc: "Ask across channels, CRM, tasks, reports, and business data. Ivy coordinates the right agents and returns one grounded answer.",
    stats: [{ v: "All", l: "connected agents" }, { v: "1", l: "assistant" }],
    img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/analyst-Ysxnqg7Fpy2cfA56PiIttv1KximMhT.png",
  },
  {
    label: "ACTION AGENT",
    title: "Work that moves itself forward",
    desc: "Sends replies, creates tasks and documents, updates connected systems, and routes sensitive actions through human approval.",
    stats: [{ v: "100%", l: "traceable" }, { v: "Human", l: "in control" }],
